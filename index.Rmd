...
## Activity: What should we document in this dataset?
...
* README template: [download .md](data/README_template.md) or [download .txt](data/README_template.txt)
  * *based off of the Cornell and University of Arizona templates*
* Data dictionary template: [download .txt](data/data_dictionary_template.txt) or [download tabular version, .csv](data/data_dictionary_tabular_template.csv)
...
* Workflow diagram template (uses Powerpoint):[download .ppt](data/workflow_diagram_template.ppt)
