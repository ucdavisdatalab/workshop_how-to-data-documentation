...
<mark> Move up in reader? Add scope disclaimer at beginning that we will not cover structured metadata extensively in this workshop? </mark>

In this workshop, we have discussed initial metadata to start the process of documenting your project. These forms of metadata are relatively simple and are considered *unstructured* metadata. 
As projects become more complex, incorporate more collaborators, or are conducted as part of institutes or large consortiums, more structured metadata standards tend to be used. 
