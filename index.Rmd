...
Other example questions can be found here: [Metadata Questions in Plain Language (USGS)](https://geology.usgs.gov/tools/metadata/tools/doc/ctc/). 

You should be able to answer many of these questions as you build out your documentation through readmes and data dictionaries associated with your project. 
...
* [README.md](https://github.com/ecalfee/MissDemeanors/blob/master/README.md) for the [2020 CA Election Data Challenge](https://datalab.ucdavis.edu/ca-election-2020-data-challenge/) winning team's project
...
* [README.md](https://github.com/Carceral-Ecologies/Carceral-Proximity-Analysis/blob/master/README.md) for the [Hack for California](https://datalab.ucdavis.edu/hack-for-california/) Carceral Ecologies Project.
...
* README template: [markdown](template_files/README_template.md) or [plain text (.txt)](data/README_template.txt)
...
* Data for the studio-section demo comes from [FiveThirtyEight's analysis of Hollywood movie budgets and representation of women](https://fivethirtyeight.com/features/the-dollar-and-cents-case-against-hollywoods-exclusion-of-women/)
  * Datasets were sourced from [data.world](https://data.world/fivethirtyeight/bechdel)
